...
#    Updated: 2025/01/03 12:49:18 by mpoplow          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME): $(LIBMLX)/.git $(OFILES)
	...
	@echo "\033[1;32mCREATE PROGRAM: SO_LONG_BONUS\033[0m"
...
fclean: clean
	@echo "\033[1;33mREMOVE PROGRAM SO_LONG_BONUS\033[0m"
	@rm -f $(NAME)
	@rm -rf ./MLX42
